  ...
  <div class="app-container">
    ...
    <el-form :model="form" ref="form" label-width="100px"  :rules="rules">
      <el-form-item label="年级：" prop="gradeLevel" required>
        ...
        <el-button type="" @click="toSubject">toSubject</el-button>
      </el-form-item>
      ...
      <el-form-item label="选项：" required>
        <el-form-item :label="item.prefix" :key="item.prefix"  
        v-for="(item,index) in form.items"  label-width="50px" class="question-item-label">
          ...
          ></span>
           ...
           class="question-item-remove" icon="el-icon-delete" 
