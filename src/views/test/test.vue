...
<div @click="changeTableName(item)"
  :key="item" v-for="item in autoPaper">
   {{item}}
 </div>

 
<el-button type="" @click="findAllEsQuestion_do">findAllEsQuestion_do</el-button>

findAllEsQuestion
<div @click="changeTableName(item)"
  :key="item" v-for="item in findAllEsQuestion">
   {{item}}
 </div>
